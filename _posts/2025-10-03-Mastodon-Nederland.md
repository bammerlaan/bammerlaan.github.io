...
<figure class="fr-ns w-50-ns br3 ma1 ba b--light-gray">
    ...
    <img src="/images/blog/2025/Mastodon-Nederland/fedi.tips_Bluesky-vs-Fediverse.png" alt="Diagrammen van hoe BlueSky en zijn AT Protocol functioneren, vergeleken met hoe de Fediverse en zijn ActivityPub-protocol functioneren.

    Het verkeer van BlueSky stroomt van servers naar relays die eigendom zijn van bedrijven, en deze relays communiceren met elkaar voordat ze het verkeer naar de servers laten stromen. De servers kunnen helemaal niet met elkaar communiceren.

    Het verkeer van The Fediverse stroomt direct tussen goedkoop te beheren servers, zonder dat er een bedrijf aan te pas hoeft te komen.

    Hoewel dit technisch gezien beide vormen van decentralisatie zijn, geeft de BlueSky-interpretatie de volledige controle over het netwerk aan corporaties, rijke mensen en welvarende organisaties. De Fediverse-interpretatie geeft de volledige controle over het netwerk aan gewone mensen." class="br3 br--top"></a>
    <figcaption class="tc">De decentralisatie van Bluesky vergeleken met Mastodon. (Bron: Fedi.Tips)</figcaption>
</figure>

Bluesky heeft een beetje een reputatie dat mensen wat linkser op het politieke spectrum er de voorkeur voor hebben, en dat het ook "gedecentraliseerd" is. En technisch is dat waar, maar toch niet helemaal hetzelfde. Een gebruiker van Mastodon die zich specialiseert in informatie over de Fediverse beschrijft het als volgt:

<blockquote>
<svg class="inline_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M407.8 294.7c-3.3-.4-6.7-.8-10-1.3 3.4 .4 6.7 .9 10 1.3zM288 227.1C261.9 176.4 190.9 81.9 124.9 35.3 61.6-9.4 37.5-1.7 21.6 5.5 3.3 13.8 0 41.9 0 58.4S9.1 194 15 213.9c19.5 65.7 89.1 87.9 153.2 80.7 3.3-.5 6.6-.9 10-1.4-3.3 .5-6.6 1-10 1.4-93.9 14-177.3 48.2-67.9 169.9 120.3 124.6 164.8-26.7 187.7-103.4 22.9 76.7 49.2 222.5 185.6 103.4 102.4-103.4 28.1-156-65.8-169.9-3.3-.4-6.7-.8-10-1.3 3.4 .4 6.7 .9 10 1.3 64.1 7.1 133.6-15.1 153.2-80.7 5.9-19.9 15-138.9 15-155.5s-3.3-44.7-21.6-52.9c-15.8-7.1-40-14.9-103.2 29.8-66.1 46.6-137.1 141.1-163.2 191.8z"/></svg> Bluesky is ontworpen om corporaties en rijkelui de volledige controle over het netwerk te geven. Alle data moet door dezelfde door corporaties gerunde relays stromen die veel geld kosten om te laten draaien.<br><br>

<svg class="inline_icon" xmlns="http://www.w3.org/2000/svg" viewBox="-10 -5 1034 1034"><path d="M539 176q-32 0 -55 22t-25 55t20.5 58t56 27t58.5 -20.5t27 -56t-20.5 -59t-56.5 -26.5h-5zM452 271l-232 118q20 20 25 48l231 -118q-19 -20 -24 -48zM619 298q-13 25 -38 38l183 184q13 -25 39 -38zM477 320l-135 265l40 40l143 -280q-28 -5 -48 -25zM581 336
...
q2 9 1 18q-1 19 -9 35l256 41q-1 -9 -1 -18q1 -18 10 -35zM646 863q-32 0 -55 22.5t-24.5 55t20.5 58t56 27t59 -21t27 -56t-20.5 -58.5t-56.5 -27h-6z"/></svg> De Fediverse is ontworpen om gewone mensen controle over het netwerk te geven. Alle data stroomt direct van de ene goedkoop-te-beheren server naar de andere.
</blockquote>
—[Fedi.Tips](https://social.growyourown.services/@FediTips/113896029909649321) (Mijn vertaling.)

En niks houdt Bluesky tegen om dezelfde kant op te gaan als X: het is in handen van één bedrijf, wat volledig bepaalt wat er zoal op gezegd mag worden en welke berichten door het algoritme sneller op de tijdlijn van mensen worden geplaatst. Daar hebben ze terwijl ik dit schrijf [een leuk stukje ophef](https://mastodon.social/@benroyce/115314469411526101) over op Bluesky, zelfs.
